...
FILES=("init.sh"  "aptinstalls.sh" "aptcache.sh" "remove-aptcache.sh" "proxy-apt-detect.sh" "setup.sh" "sudoadd.sh" "storage.sh" "programs.sh" "nvidia.sh" "nomachine.sh" "openalpr.sh")
